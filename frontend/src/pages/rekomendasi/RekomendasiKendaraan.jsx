// src/pages/rekomendasi/RekomendasiKendaraan.jsx
...
// Data untuk setiap paket asuransi kendaraan
const vehiclePackagesData = [
  {
    title: 'Finzure Autocare Bronze Basic',
    packageName: 'Paket Bronze',
    packageClass: 'tag-bronze',
    rating: 3,
    features: '+TLO (Total Loss Only)',
    price: 'Rp.300.000/Bulan',
    icon: 'bi-shield-check',
  },
  {
    title: 'Finzure Autocare Bronze Plus',
    packageName: 'Paket Bronze',
    packageClass: 'tag-bronze',
    rating: 3,
    features: '+TLO + layanan darurat',
    price: 'Rp.300.000/Bulan',
    icon: 'bi-shield-plus',
  },
  {
    title: 'Finzure Autocare Silver Basic',
    packageName: 'Paket Silver',
    packageClass: 'tag-silver',
    rating: 4,
    features: '+All Risk dasar',
    price: 'Rp.300.000/Bulan',
    icon: 'bi-shield-check',
  },
  {
    title: 'Finzure Autocare Silver Plus',
    packageName: 'Paket Silver',
    packageClass: 'tag-silver',
    rating: 4,
    features: '+All Risk + tambahan fitur',
    price: 'Rp.300.000/Bulan',
    icon: 'bi-shield-plus',
  },
  {
    title: 'Finzure Autocare Silver Premium',
    packageName: 'Paket Silver',
    packageClass: 'tag-silver',
    rating: 4,
    features: '+All Risk + banjir dan TPL',
    price: 'Rp.300.000/Bulan',
    icon: 'bi-shield-plus',
  },
  {
    title: 'Finzure Autocare Gold Basic',
    packageName: 'Paket Gold',
    packageClass: 'tag-gold',
    rating: 5,
    features: '+All Risk + penumpang & pengemudi',
    price: 'Rp.300.000/Bulan',
    icon: 'bi-shield-plus',
  },
  {
    title: 'Finzure Autocare Gold Plus',
    packageName: 'Paket Silver',
    packageClass: 'tag-silver',
    rating: 5,
    features: '+Layanan mobil pengganti dan derek premium',
    price: 'Rp.300.000/Bulan',
    icon: 'bi-shield-plus',
  },
  {
    title: 'Finzure Autocare Gold Premium',
    packageName: 'Paket Gold',
    packageClass: 'tag-gold',
    rating: 5,
    features: '+Perlindungan Komperehensif',
    price: 'Rp.300.000/Bulan',
    icon: 'bi-shield-plus',
  },
];
...
function RekomendasiKendaraan() {
  ...
  const handleAmbilPaket = (paket) => {
    logActivity({
      type: 'Pengambilan Paket Kendaraan',
  ...
  <div className="container mx-auto px-4 sm:px-6 py-8 sm:py-16 relative z-10">
    ...
    <div className="mt-10 sm:mt-20 text-center mb-8 sm:mb-16">
      <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4 tracking-tight px-4">
        Hasil Rekomendasi
        <span className="bg-gradient-to-r from-cyan-400 to-purple-400 bg-clip-text text-transparent block sm:inline"> Asuransi Kendaraan</span>
      </h1>
    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 max-w-6xl mx-auto">
      {vehiclePackagesData.map((pkg, index) => (
