...
# Load data produk kesehatan
produk = pd.read_csv('Data Produk Kesehatan.csv')

# Pastikan kolom 'produk_idx' ada
...
# Buat mapping produk2idx dan user2idx
...
# Load model rekomendasi kesehatan
model = load_model('rekomendasi_kesehatan.h5', compile=False)

# Load scaler premi kesehatan
scaler_premi = joblib.load('scaler_rekomendasi_kesehatan.pkl')
...
def recommend_hybrid_by_user_premi(user_id, premi_user, top_n=10):
    ...
    # Gabungkan hasil prediksi dengan data produk
